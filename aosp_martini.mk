...
PRIVATE_BUILD_DESC="OnePlus9RT-user 13 TP1A.220905.001 R.1307645_1-2e77b release-keys" \
    TARGET_DEVICE=$(PRODUCT_SYSTEM_DEVICE) \
    TARGET_PRODUCT=$(PRODUCT_SYSTEM_NAME)
    
BUILD_FINGERPRINT := OnePlus/OnePlus9RT/OP5155L1:13/TP1A.220905.001/R.1307645_1-2e77b:user/release-keys
